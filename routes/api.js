...
router.post('/user/removeseeded/:endUserID',verifyToken,friend_controller.remove_seeded_friend)
...
router.post('/user/seedfriend/:endUserID',verifyToken,friend_controller.seed_friend)
